...
import { Schema } from "compassql/build/compassql";
...
describe("api/api", () => {
  describe("fetchCompassQLRecommend", () => {
    ...
    it("should return results for local recommend", () => {
      expect.assertions(1);
      return fetchCompassQLRecommend(q, schema, data).then((result) => {
    ...
    it("should return results for remote recommend", () => {
      ...
      return fetchCompassQLRecommend(q, schema, data, {
  ...
  describe("fetchCompassQLBuildSchema", () => {
    ...
    it("should return results for local recommend", () => {
      expect.assertions(1);
      return fetchCompassQLBuildSchema(data).then((result) => {
    ...
    it("should return results for remote recommend", () => {
      ...
      return fetchCompassQLBuildSchema(data, {
        serverUrl: "http://localhost",
      }).then((result) => {
        return expect(result.fieldNames().length).toEqual(0);
      });
