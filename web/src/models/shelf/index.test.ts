...
describe("models/shelf", () => {
  ...
  describe("toQuery", () => {
    it(
      "returns a query that groups by encoding and does not auto add count " +
    ...
    it(
      "returns the query that groups by field and autoAddCount" +
      ...
      () => {
        expect(
          ...
          spec: {
            mark: "point",
            encodings: [{ channel: "x", field: "?", type: "quantitative" }],
            config: { numberFormat: "d" },
          },
          groupBy: "field",
          chooseBy: DEFAULT_CHOOSE_BY,
    ...
    it(
      "returns the query that groups by field transform and auto add count " +
